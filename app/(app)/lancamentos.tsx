...
const styles = StyleSheet.create({
  ...
  rowSub: { color: theme.inkFaint, fontSize: type.legenda, lineHeight: lh(type.legenda, 'apoio'), marginTop: spacing.fio, fontFamily: fonts.light },
  ...
  categoryChipsRow: { gap: spacing.icone },
  categoryChip: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.icone,

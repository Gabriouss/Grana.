    ...
    try {
      if (isDemoMode && pagandoRestante && currentInvoicePayment) {
        const fakeTx: Transaction = {
          ...
          user_id: 'demo',
          type: 'out',
          description: `Pagamento da fatura ${selectedCard.name} (${formatMonthYear(viewYear, viewMonth)}), restante`,
          amount,
        ...
        const fakeTx: Transaction = {
          ...
          user_id: 'demo',
          type: 'out',
          description: `Pagamento da fatura ${selectedCard.name} (${formatMonthYear(viewYear, viewMonth)})`,
          amount,
          category: 'Cartão de crédito',
          color: selectedCard.color,
          occurred_on: payDate,

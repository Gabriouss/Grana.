...
3. **Som:** a trilha a −5 dB e o "plim" de sucesso (`../identidade-sonora/plim-sucesso.wav`) a −16 dB (baixado 10 dB a pedido do autor na v6), em 10,8 s.
...
## v5, ajustes do autor (26/09/2026)

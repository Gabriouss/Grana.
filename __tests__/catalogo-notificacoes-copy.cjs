...
const REESCRITAS = {
  ...
  'noturno-2': ['Um minutinho só', 'Se ficou algo de hoje pra registrar, o Grana. está aqui 🌙'],
  'noturno-3': ['Antes de dormir', 'Com o celular na mão, que tal ver se falta algum lançamento de hoje? 😉'],
  'noturno-4': ['Resuminho do dia', 'Como foi o dia no bolso? Se tiver algo pra registrar, é por aqui 💭'],
  'noturno-5': ['Antes de encerrar', 'Algum gasto de hoje ficou de fora? Dá pra lançar agora 📒'],
  ...
  'streak-6': ['No seu ritmo', 'Sua sequência de {streak} dias segue com você. Registre hoje quando for melhor 🙂'],
  'streak-7': ['Cada dia soma', 'Sua sequência está em {streak} dias. Registrando hoje, ela cresce mais um 🔥'],
  'streak-8': ['Boa constância', '{streak} dias seguidos registrando. Hoje pode ser mais um 🔥'],
  ...
  'micro-3': ['Lanche rápido?', 'Se teve um lanche rápido hoje, ele entra no controle do mesmo jeito 🥪'],
  'micro-6': ['Um agrado hoje?', 'Se você se deu um agrado hoje (e tudo bem!), dá pra registrar 🍫'],
  'micro-7': ['Os pequenos da rotina', 'Estacionamento, aplicativo, assinatura: os pequenos também merecem um lugar no Grana. 🅿️'],
  ...
  'dica-5': ['Compra no mercado?', 'Na próxima compra, escaneie o QR da nota e o Grana. ajuda a preencher o lançamento 🛒'],
  'almoco-1': ['Pausa do meio-dia', 'Teve algo para registrar? Dá para fazer agora ou depois 🍴'],
  'almoco-2': ['Hora do almoço', 'Se o almoço tiver gasto, dá pra registrar quando quiser 🥡'],
  'almoco-3': ['Hora do intervalo', 'Se teve algum gasto de manhã, a pausa é um bom momento pra registrar 🕐'],
  'almoco-4': ['Extras do dia', 'Suco, café ou sobremesa: se teve, dá pra registrar 🥤'],
  ...
  'almoco-9': ['Olhada rápida', 'Algum gasto da manhã ficou de fora do Grana.? 🔎'],
};

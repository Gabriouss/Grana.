...
import { theme, spacing, PALETTE_30, fonts, type, lh } from '@/lib/theme';
...
const styles = StyleSheet.create({
  ...
  hint: { color: theme.inkFaint, fontSize: type.legenda, lineHeight: lh(type.legenda, 'corpo'), fontFamily: fonts.light },
});

 ...
 *
 * O nome da carteira nunca se esconde por causa do título da tela: o
 * `ScreenHeader` já resolve a disputa por espaço do lado dele — `right` tem
 * `flexShrink: 0` e o título tem `numberOfLines={2}`, então é o título que
 * quebra linha (ou elide, como último recurso) enquanto a pílula mantém
 * tamanho fixo. Esconder o nome aqui só tirava informação sem necessidade.
 */

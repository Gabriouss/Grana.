...
export default function ToggleSwitch({ value, onToggle, hitSlop = 12 }: { value: boolean; onToggle: () => void; hitSlop?: number }) {
  ...
  return (
    <AppPressable onPress={onToggle} hitSlop={hitSlop} scaleOnPress={false}>

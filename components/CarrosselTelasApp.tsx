...
const TELAS: Tela[] = [
  { src: '/telas/inicio-mobile.png?v=20260925', rotulo: 'Início', legenda: 'Tela de Início do Grana. no celular, com Livre para Gastar, cofrinhos e comprometimento futuro' },

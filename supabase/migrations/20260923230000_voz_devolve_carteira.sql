...
-- e conferir se ela tem `wallet_id` e 'assistente'. Se tiver algo que nao
-- esta aqui, parar e reconciliar antes.

-- A origem 'assistente' tambem na tabela. Repete o que 20260914120000 faz,
-- de proposito: se aquela migration nao estiver aplicada em producao, a RPC
-- abaixo aceitaria 'assistente' e o INSERT em voice_operations quebraria.
-- Idempotente: acha a restricao de origem pelo conteudo, derruba e recria.
do $$
declare
  v_nome text;
begin
